...
namespace Ejercicio_practico_2_Abecedario_num_voc
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                for (int j = 0; j < 10; j++)
                {
                    ...
                    //converting vocals to numbers
                    if (abc[numAleatorio] == "A")
                    {
                        abc[numAleatorio] = "4";
                    }
                    else if (abc[numAleatorio] == "E")
                    {
                        abc[numAleatorio] = "3";
                    }
                    else if (abc[numAleatorio] == "I")
                    {
                        abc[numAleatorio] = "1";
                    }
                    else if (abc[numAleatorio] == "O")
                    {
                        abc[numAleatorio] = "0";
                    }
                    else if (abc[numAleatorio] == "U")
                    {
                        abc[numAleatorio] = "7";
                    }
